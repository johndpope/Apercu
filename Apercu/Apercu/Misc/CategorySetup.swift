...
class CategorySetup {
    ...
    func initializeCategoryData() {
        ...
        if categoryTableIsEmpty() {
            ...
            let color5: UIColor = UIColor(red: 24.0 / 255.0, green: 143.0 / 255.0, blue: 48.0 / 255.0, alpha: 1)
            let color6: UIColor = UIColor(red: 194.0 / 255.0, green: 207.0 / 255.0, blue: 52.0 / 255.0, alpha: 1)
